...
public class Storage {
  ...
  public Boolean searchDirectory(String searchDir, String fileName) {
    ...
    try {
      BufferedReader br =
          new BufferedReader(new FileReader(searchDir + File.separator + fileListName));
  ...
  public List<String> searchForFile(String query) {
    ...
    String regex = "(.*)" + query + "(.*)";
    try {
      BufferedReader cacheFileListingReader =
          new BufferedReader(new FileReader(cacheDir + File.separator + fileListName));
      BufferedReader localFileListingReader =
          new BufferedReader(new FileReader(localDir + File.separator + fileListName));
