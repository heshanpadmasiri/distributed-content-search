...
public abstract class AbstractFileTransferService {
     ...
     * @throws DestinationAlreadyExistsException If the destination file already exists. <b>This method will not
     * overwrite existing files</b>
     */
    public abstract void downloadFile(String fileName, Path destination) throws FileNotFoundException, DestinationAlreadyExistsException;
     ...
     * @throws FileNotFoundException If no file is found that exactly matches the file name in the source
     * @throws DestinationAlreadyExistsException If the destination file already exists. <b>This method will not
     * overwrite existing files</b>
     * @throws NodeNotFoundException If source node refused to connect
     */
    public abstract void downloadFileFrom(String fileName, Path destination, Node source) throws FileNotFoundException,
            DestinationAlreadyExistsException, NodeNotFoundException;
